      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        {[
          ...
          { 
            ...
            category: "Vegetables", 
            price: "₹60", 
            image: require("../assets/Shopping Cart/Carrots.png") 
          },
          { 
            name: "Organic Apple", 
            category: "Fruits", 
            price: "₹120", 
            image: require("../assets/Shopping Cart/Apple.png") 
          },
        ].map((item, index) => (
...
const styles = StyleSheet.create({
  ...
  checkoutText: { color: "#fff", fontWeight: "700", textAlign: "center", fontSize: 16 },
});
